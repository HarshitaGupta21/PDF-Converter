package pdfconverterhhkg.dudepdfconverterhhkg.providers.fragmentmanagement;
...
import pdfconverterhhkg.dudepdfconverterhhkg.activity.WelcomeActivity;
import pdfconverterhhkg.dudepdfconverterhhkg.fragment.AboutUsFragment;
import pdfconverterhhkg.dudepdfconverterhhkg.fragment.AddImagesFragment;
import pdfconverterhhkg.dudepdfconverterhhkg.fragment.AddTextFragment;
...
import pdfconverterhhkg.dudepdfconverterhhkg.fragment.FAQFragment;
import pdfconverterhhkg.dudepdfconverterhhkg.fragment.FavouritesFragment;
import pdfconverterhhkg.dudepdfconverterhhkg.fragment.HistoryFragment;
import pdfconverterhhkg.dudepdfconverterhhkg.fragment.HomeFragment;
...
import pdfconverterhhkg.dudepdfconverterhhkg.fragment.SettingsFragment;
...
import pdfconverterhhkg.dudepdfconverterhhkg.util.FeedbackUtils;
import pdfconverterhhkg.dudepdfconverterhhkg.util.FragmentUtils;

import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ACTION_MERGE_PDF;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ACTION_SELECT_IMAGES;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ACTION_TEXT_TO_PDF;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ACTION_VIEW_FILES;
...
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.SHOW_WELCOME_ACT;
    ...
    public boolean handleNavigationItemSelected(int itemId) {
        ...
        switch (itemId) {
            ...
            case R.id.nav_rateus:
                mFeedbackUtils.openWebPage("https://play.google.com/store/apps/details?id=pdfconverterhhkg.dudepdfconverterhhkg");
                break;
