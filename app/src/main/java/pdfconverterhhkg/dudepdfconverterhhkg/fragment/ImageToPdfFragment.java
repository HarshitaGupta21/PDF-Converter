package pdfconverterhhkg.dudepdfconverterhhkg.fragment;
...
import pdfconverterhhkg.dudepdfconverterhhkg.activity.CropImageActivity;
import pdfconverterhhkg.dudepdfconverterhhkg.activity.ImageEditor;
import pdfconverterhhkg.dudepdfconverterhhkg.activity.PreviewActivity;
import pdfconverterhhkg.dudepdfconverterhhkg.activity.RearrangeImages;
import pdfconverterhhkg.dudepdfconverterhhkg.adapter.EnhancementOptionsAdapter;
import pdfconverterhhkg.dudepdfconverterhhkg.database.DatabaseHelper;
import pdfconverterhhkg.dudepdfconverterhhkg.interfaces.OnItemClickListener;
import pdfconverterhhkg.dudepdfconverterhhkg.interfaces.OnPDFCreatedInterface;
import pdfconverterhhkg.dudepdfconverterhhkg.model.EnhancementOptionsEntity;
import pdfconverterhhkg.dudepdfconverterhhkg.model.ImageToPDFOptions;
import pdfconverterhhkg.dudepdfconverterhhkg.model.Watermark;
import pdfconverterhhkg.dudepdfconverterhhkg.util.Constants;
import pdfconverterhhkg.dudepdfconverterhhkg.util.CreatePdf;
import pdfconverterhhkg.dudepdfconverterhhkg.util.DialogUtils;
import pdfconverterhhkg.dudepdfconverterhhkg.util.FileUtils;
import pdfconverterhhkg.dudepdfconverterhhkg.util.ImageEnhancementOptionsUtils;
import pdfconverterhhkg.dudepdfconverterhhkg.util.ImageUtils;
import pdfconverterhhkg.dudepdfconverterhhkg.util.MorphButtonUtility;
import pdfconverterhhkg.dudepdfconverterhhkg.util.PageSizeUtils;
import pdfconverterhhkg.dudepdfconverterhhkg.util.PermissionsUtils;
import pdfconverterhhkg.dudepdfconverterhhkg.util.StringUtils;

import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.AUTHORITY_APP;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.DEFAULT_BORDER_WIDTH;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.DEFAULT_COMPRESSION;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.DEFAULT_PAGE_COLOR;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.DEFAULT_PAGE_SIZE;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.DEFAULT_QUALITY_VALUE;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.MASTER_PWD_STRING;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.OPEN_SELECT_IMAGES;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.READ_WRITE_CAMERA_PERMISSIONS;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.RESULT;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.STORAGE_LOCATION;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.appName;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.WatermarkUtils.getStyleNameFromFont;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.WatermarkUtils.getStyleValueFromName;
