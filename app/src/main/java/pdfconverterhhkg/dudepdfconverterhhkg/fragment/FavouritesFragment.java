...
import pdfconverterhhkg.dudepdfconverterhhkg.activity.FavouritesActivity;
import pdfconverterhhkg.dudepdfconverterhhkg.activity.MainActivity;
import pdfconverterhhkg.dudepdfconverterhhkg.customviews.MyCardView;
import pdfconverterhhkg.dudepdfconverterhhkg.fragment.texttopdf.TextToPdfFragment;
import pdfconverterhhkg.dudepdfconverterhhkg.model.HomePageItem;
import pdfconverterhhkg.dudepdfconverterhhkg.util.CommonCodeUtils;

import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ADD_IMAGES;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ADD_IMAGES_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ADD_PASSWORD_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ADD_PWD;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ADD_TEXT_KEY;
...
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.COMPRESS_PDF;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.COMPRESS_PDF_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.EXCEL_TO_PDF_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.EXTRACT_IMAGES;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.EXTRACT_IMAGES_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.EXTRACT_TEXT_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.HISTORY_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.IMAGE_TO_PDF_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.INVERT_PDF_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.MERGE_PDF_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.PDF_TO_IMAGES;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.PDF_TO_IMAGES_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.QR_BARCODE_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.REMOVE_PAGES;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.REMOVE_PAGES_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.REMOVE_PASSWORD_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.REMOVE_PWd;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.REORDER_PAGES;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.REORDER_PAGES_KEY;
...
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.SPLIT_PDF_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.TEXT_TO_PDF_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.VIEW_FILES_KEY;
import static pdfconverterhhkg.dudepdfconverterhhkg.util.Constants.ZIP_TO_PDF_KEY;
