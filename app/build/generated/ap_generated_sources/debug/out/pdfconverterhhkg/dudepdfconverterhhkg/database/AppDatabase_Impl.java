package pdfconverterhhkg.dudepdfconverterhhkg.database;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoHistory.equals(_existingHistory)) {
          throw new IllegalStateException("Migration didn't properly handle History(pdfconverterhhkg.dudepdfconverterhhkg.database.History).\n"
                  + " Expected:\n" + _infoHistory + "\n"
                  + " Found:\n" + _existingHistory);
        }
      }
